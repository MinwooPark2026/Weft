...
def _run(argv: list[str] | None = None) -> int:
    ...
    img_cmd = sub.add_parser("images", help="Generate shot images (OpenAI/Gemini/ComfyUI) into the project dir")
    ...
    img_cmd.add_argument("--size", help="image size override (default: derived from IMAGE_ASPECT, e.g. 1920x1080)")
